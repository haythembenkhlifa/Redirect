...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-redirect', __webpack_require__(3));
  Vue.component('detail-redirect', __webpack_require__(6));
  Vue.component('form-redirect', __webpack_require__(9));
});
